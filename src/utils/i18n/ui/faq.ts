...
export const faq = {
  es: {
    "faq.seo.title": "Preguntas frecuentes",
    "faq.seo.description": "Respondiendo a Preguntas Frecuentes sobre nuestros servicios de animación y diseño",
    ...
    "faq.answer3": `En 3 simples pasos: <ul> <li>Hablamos: Concertamos un horario para hablar (por teléfono o video) y así poder discutir sobre lo que necesitas y cómo puedo ayudarte.</li> <li>Planificamos: Te entrego una propuesta clara que describe los entregables, los plazos y el presupuesto. <br>Una vez aprobada la propuesta puedo comenzar a trabajar.</li> <li>Resultados: Entrego el proyecto finalizado en el plazo acordado.</li></ul>`,
  ...
  en: {
    "faq.seo.title": "Frequently asked questions",
    "faq.seo.description": "Answering Frequently Asked Questions about our animation and design services",
    ...
    "faq.answer3": `In 3 simple steps: <ul> <li>We talk: We'll book a time to speak (phone/video) so that we can discuss what you need and how I can help you.</li> <li>We plan: I provide you with a clear proposal outlining deliverables, timelines and a budget. <br>Once the proposal is approved, I can get to work.</li> <li>Results: I deliver the finished project within the agreed-upon timeline.</li></ul>`,
